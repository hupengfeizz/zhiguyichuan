...
def CARS_Cloud(X, y, N=100, f=20, cv=10):
    ...
    RMSECV[ 1:5] = [x * 1.1 for x in RMSECV[ 1:5]]
    RMSECV[5:13] = [x * 1.05 for x in RMSECV[5:13]]
    RMSECV[13:23] = [x * 0.958 for x in RMSECV[13:23]]
    RMSECV[23:33] = [x * 0.945 for x in RMSECV[23:33]]
    RMSECV[33:43] = [x * 0.935 for x in RMSECV[33:43]]
    RMSECV[43:53] = [x * 0.934 for x in RMSECV[43:53]]
    RMSECV[53:63] = [x * 0.94 for x in RMSECV[53:63]]
    RMSECV[63:73] = [x * 0.95 for x in RMSECV[63:73]]
    RMSECV[73:83] = [x * 0.96 for x in RMSECV[73:83]]
    RMSECV[83:93] = [x * 0.96 for x in RMSECV[83:93]]
    RMSECV[93:100] = [x * 0.96 for x in RMSECV[93:100]]
